...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    public void putIter(Key key, Value val) {
        ...
        currentNode = new Node(key, val, 1);
    }
    ...
    /**
     * Returns all keys in the symbol table in the given explore,
     * as an {@code Iterable}.
     *
    ...
    /**
     * Returns the number of keys in the symbol table in the given explore.
     *
     * @param  lo minimum endpoint
     * @param  hi maximum endpoint
